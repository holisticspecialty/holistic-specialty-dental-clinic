...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-brand-bg/90 backdrop-blur-md border-b border-gray-200/50">
      <div className="max-w-7xl mx-auto px-6 md:px-12 h-[72px] flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="font-serif text-[1.15rem] md:text-[1.35rem] tracking-tight text-brand-primary leading-tight">
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link 
            href="/booking"
            className="inline-flex items-center justify-center px-5.5 py-2.25 bg-brand-primary text-white text-[13px] font-medium rounded-md hover:bg-brand-primary/90 transition-colors"
